		...
		for(socket_index=0;socket_index<max_clients;socket_index++)
		{
			...
			if(FD_ISSET(sd , &readfds))
			{
				...
				else
				{
					...
					else if(buffer[0] == 's' && buffer[1] == 'u' && buffer[2] == 'b' && buffer[3] == 's' && buffer[4] == 'c' && buffer[5] == 'r' && buffer[6] == 'i' && buffer[7] == 'b' && buffer[8] == 'e')
					{
						if(strlen(login_user[socket_index].username) == 0)
						{
							char *message = "Please login first.\n";
						...
						else
						{
							if(buffer[12] == 'b')
							{
								...
								if(count != 4)
								{
									char *message = "[Invalid option] usage:subscribe --board <boardname> --keyword <keyword>\n";
									send(sd, message, strlen(message), 0);
								}
								else
								{
							...
							if(buffer[12] == 'a')
							{
								...
								if(count != 4)
								{
									char *message = "[Invalid option] usage:subscribe --author <authorname> --keyword <keyword>\n";
									send(sd, message, strlen(message), 0);
								}
								else
								{
					...
					else if(buffer[0] == 'u' && buffer[1] == 'n' && buffer[2] == 's' && buffer[3] == 'u' && buffer[4] == 'b' && buffer[5] == 's' && buffer[6] == 'c' && buffer[7] == 'r' && buffer[8] == 'i' && buffer[9] == 'b' && buffer[10] == 'e')
					{
						if(strlen(login_user[socket_index].username) == 0)
						{
							char *message = "Please login first.\n";
					...
					else if(buffer[0] == 'l' && buffer[1] == 'i' && buffer[2] == 's' && buffer[3] == 't' && buffer[4] == '-' && buffer[5] == 's' && buffer[6] == 'u' && buffer[7] == 'b')
					{
						if(strlen(login_user[socket_index].username) == 0)
						{
							char *message = "Please login first.\n";
